...
class Model(nn.Module):   
    ...
    def forward(self, input_ids=None,labels=None): 
        ...
        embedding_layer = self.encoder.get_input_embeddings()   # 50265*768
    ...
    def embedding_forward(self, embedding, label=None):
        outputs = self.encoder(inputs_embeds=embedding)[0]
        logits=self.classifier(outputs)
        loss_fct = CrossEntropyLoss()
        loss = None
